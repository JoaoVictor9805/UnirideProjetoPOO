...
public class EdicaoSolicitacaoController {
    private Stage palco;
    ...
    public EdicaoSolicitacaoController(Stage palco) {
        this.palco = palco;
    }

    public void atualizarSolicitacao(int indiceLinha, String novoTitulo,
                                      String novoLocalPartida, String novoLocalDestino,
                                      LocalDate novaData) {
        ...
        String novaLinha = novoTitulo + " | " + novoLocalPartida + " | "
                + novoLocalDestino + " | " + novaData.format(FORMATO_DATA);
        ...
        try (FileWriter fw = new FileWriter(arquivo, false);
            ...
            bw.flush();
            System.out.println("Solicitação atualizada com sucesso no índice: " + indiceLinha);
        } catch (IOException e) {
            System.out.println("Erro ao atualizar arquivo de solicitações.");
            e.printStackTrace();
        }
    ...
    public void excluirSolicitacao(int indiceLinha) {
        File arquivo = new File(CAMINHO_ARQUIVO);
        List<String> linhasDoArquivo = new ArrayList<>();
